...
PM_START_TEXT = """
Hey there! My name is MissBeauty  - I'm here to help you manage your groups! Hit /help to find out more about how to use me to my full potential.

Want to add me to your chat? [Click here!](http://telegram.me/MissBeauty_RoBot?startgroup=botstart) 
"""

HELP_STRINGS = """
Hey! My name is MissBeauty . I am a group management bot, here to help you get around and keep the order in your groups!
...
If you have any bugs or questions on how to use me, head to [My Support Group](t.meMissBeauty_RoBot_Support) . 
...
You can donate to [My Creator](t.me/vijay_sai_devarakonda) . 
